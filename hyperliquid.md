# DeFi on Hyperliquid L1

[site](https://app.hyperliquid.xyz/) · [docs](https://hyperliquid.gitbook.io/hyperliquid-docs) · [github](https://github.com/hyperliquid-dex)
...
| Protocol | Description | Links |
| --- | --- | --- |
| [HyperLend](https://hyperlend.finance/) | Largest lending protocol on HyperEVM with $600M+ TVL | [docs](https://docs.hyperlend.finance) · [github](https://github.com/hyperlendx) |
| [Morpho Blue](https://morpho.org/) | Noncustodial lending protocol with $397M TVL on Hyperliquid | [docs](https://docs.morpho.org/) · [github](https://github.com/morpho-org) |
| [Felix Protocol](https://www.usefelix.xyz/) | CDP and lending suite with feUSD stablecoin and $210M+ TVL | — |

## DEX

| Protocol | Description | Links |
| --- | --- | --- |
| [Hyperliquid](https://app.hyperliquid.xyz/) | Native perpetual futures DEX with on-chain order book ($365M TVL) | [docs](https://hyperliquid.gitbook.io/hyperliquid-docs) |
...
| Protocol | Description | Links |
| --- | --- | --- |
| [Hyperbeat](https://hyperbeat.org/) | Meta-yield vaults and delta-neutral strategies with $128M TVL | — |
...
| Protocol | Description | Links |
| --- | --- | --- |
| [Chainlink](https://chain.link/) | Oracle provider with data feeds on HyperEVM | [docs](https://docs.chain.link/) |
