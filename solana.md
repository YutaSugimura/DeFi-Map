...
[site](https://solana.com/) · [docs](https://solana.com/docs) · [github](https://github.com/solana-labs) · [explorer](https://solscan.io/)
...
| --- | --- | --- |
| [Kamino Lend](https://kamino.finance/) | Largest lending protocol on Solana with integrated liquidity management | [docs](https://docs.kamino.finance/) · [github](https://github.com/Kamino-Finance) |
| [Jupiter Lend](https://jup.ag/) | Lending powered by Jupiter with isolated vaults and rehypothecation | [docs](https://station.jup.ag/docs) · [github](https://github.com/jup-ag) |
| [Save (Solend)](https://save.finance/) | OG lending protocol on Solana with algorithmic pool model | [docs](https://docs.save.finance/) · [github](https://github.com/solendprotocol) |
| [Marginfi](https://marginfi.com/) | Advanced DeFi lending protocol for institutional strategies | [docs](https://docs.marginfi.com/) · [github](https://github.com/mrgnlabs) |

## DEX

| Protocol | Description | Links |
| --- | --- | --- |
| [Raydium](https://raydium.io/) | AMM and liquidity provider on Solana with Serum integration | [docs](https://docs.raydium.io/) · [github](https://github.com/raydium-io) |
| [Orca](https://www.orca.so/) | User-friendly DEX on Solana with concentrated liquidity | [docs](https://docs.orca.so/) · [github](https://github.com/orca-so) |
| [Meteora DLMM](https://www.meteora.ag/) | Dynamic Liquidity Market Maker on Solana | [docs](https://docs.meteora.ag/) · [github](https://github.com/MeteoraAg) |
| [Sanctum Infinity](https://sanctum.so/) | Infinite LST liquidity pool on Solana | [docs](https://learn.sanctum.so/) · [github](https://github.com/igneous-labs) |
...
| Protocol | Description | Links |
| --- | --- | --- |
| [Binance Staked SOL (BNSOL)](https://www.binance.com/en/sol-staking) | Largest liquid staking token for SOL provided by Binance | — |
| [Jito](https://www.jito.network/) | MEV-powered liquid staking protocol on Solana with JitoSOL | [docs](https://www.jito.network/docs/) · [github](https://github.com/jito-foundation) |
| [Marinade](https://marinade.finance/) | Native and liquid staking protocol with mSOL | [docs](https://docs.marinade.finance/) · [github](https://github.com/marinade-finance) |
